CREATE OR REPLACE TABLE `big-button-383207.ads_staging.stg_google_ads_ad_group_daily`
PARTITION BY date
AS
SELECT
  customer_id,
...
FROM `big-button-383207.google_ads.p_ads_AdGroupBasicStats_8977224868`;
